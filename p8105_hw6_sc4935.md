...
y=0. And the Residual Plot has a mostly CONSTANT pattern across the X
axis.
...
```
    ...
    ##    babysex bhead blength   bwt delwt fincome frace gaweeks malform menarche
    ##    <fct>   <dbl>   <dbl> <dbl> <dbl>   <dbl> <fct>   <dbl> <fct>      <dbl>
    ##  1 1          36      52  3515   146      85 1        40.3 0             11
    ##  2 1          33      50  3459   169      75 2        40.7 0             12
    ##  3 2          35      53  3345   127      65 2        39.7 0             14
    ##  4 2          35      50  3175   140      85 2        40.6 0             14
    ##  5 1          34      63  3175   143      25 1        41.9 0             13
    ##  6 2          34      49  3118   161      45 2        38.9 0             10
    ##  7 2          33      54  3062   134      65 1        40.4 0             12
    ##  8 2          36      51  3317   136      65 1        42.6 0             14
    ##  9 1          35      51  3147   165      65 1        40.1 0             13
    ## 10 2          33      51  3289   155      65 1        41.6 0             15
...
```
    ...
    ##    <chr>     <dbl> <dbl>    <dbl>
    ##  1 0001       6.99  1.06     2.01
    ##  2 0002       6.84  1.05     1.97
    ##  3 0003       7.55  1.04     2.06
    ##  4 0004       7.44  1.02     2.03
    ##  5 0005       7.46  1.03     2.04
    ##  6 0006       7.19  1.04     2.02
    ##  7 0007       7.17  1.04     2.01
    ##  8 0008       6.81  1.04     1.96
    ##  9 0009       7.14  1.04     2.01
    ## 10 0010       7.43  1.03     2.03
...
```
    ...
    ##  1 0001      0.906         0.905  3.10     3489. 2.98e-188     1  -930. 1867.
    ##  2 0002      0.915         0.915  2.88     3901. 2.82e-196     1  -903. 1811.
    ##  3 0003      0.922         0.922  2.70     4303. 2.21e-203     1  -879. 1764.
    ##  4 0004      0.913         0.913  2.94     3816. 1.11e-194     1  -910. 1826.
    ##  5 0005      0.924         0.924  2.74     4438. 1.24e-205     1  -885. 1777.
    ##  6 0006      0.902         0.902  3.10     3342. 3.48e-185     1  -930. 1865.
    ##  7 0007      0.914         0.914  2.90     3853. 2.25e-195     1  -905. 1816.
    ##  8 0008      0.934         0.933  2.69     5101. 7.89e-216     1  -878. 1761.
    ##  9 0009      0.914         0.914  2.91     3867. 1.23e-195     1  -907. 1819.
    ## 10 0010      0.915         0.915  2.93     3904. 2.51e-196     1  -909. 1823.
